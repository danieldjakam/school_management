...
CREATE DATABASE IF NOT EXISTS `school_manement` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
-- Listage des données de la table school_management.class : ~1 rows (environ)
/*!40000 ALTER TABLE `class` DISABLE KEYS */;
INSERT IGNORE INTO `class` (`id`, `name`, `section`) VALUES
	('eyJhbGciOiJIUzI1NiJ9.U2lsIEI.cJlfh-J53quTXCbAFWXImGXV9XWJxASbWf5N2ktBo6Q', 'Sil B', 'fr');
...
INSERT IGNORE INTO `com` (`id`, `name`, `section`) VALUES
...
INSERT IGNORE INTO `matiere` (`id`, `name`, `slug`, `section`, `comId`, `tags`) VALUES
...
-- Listage des données de la table school_management.notes : ~68 rows (environ)
/*!40000 ALTER TABLE `notes` DISABLE KEYS */;
INSERT IGNORE INTO `notes` (`id`, `student_id`, `exam_id`, `class_id`, `matiere_id`, `tag_name`, `value`) VALUES
...
INSERT IGNORE INTO `seq` (`id`, `name`) VALUES
...
-- Listage des données de la table school_management.stats : ~3 rows (environ)
/*!40000 ALTER TABLE `stats` DISABLE KEYS */;
INSERT IGNORE INTO `stats` (`id`, `student_id`, `class_id`, `exam_id`, `totalPoints`) VALUES
...
INSERT IGNORE INTO `students` (`id`, `name`, `subname`, `email`, `phone_number`, `class_id`, `sex`, `birthday`) VALUES
	('eyJhbGciOiJIUzI1NiJ9.VHVjaGU.zo4kH5TAUyoxJeKoHfTDVWqjLe5qXjergf-hNMmCfLk', 'Tuche', 'Jean', 'iriir@lll.coo', '99999002020', 'eyJhbGciOiJIUzI1NiJ9.U2lsIEI.cJlfh-J53quTXCbAFWXImGXV9XWJxASbWf5N2ktBo6Q', 'm', '2022-05-03'),
...
-- Listage des données de la table school_management.teachers : ~1 rows (environ)
/*!40000 ALTER TABLE `teachers` DISABLE KEYS */;
INSERT IGNORE INTO `teachers` (`id`, `name`, `subname`, `class_id`) VALUES
	('eyJhbGciOiJIUzI1NiJ9.VGVhY2hlcg.iaLuh-SltkyY36sQLf_2FwOBgYbg1H-oUw2FD7sAKYg', 'Teacher', 'du Net', 'eyJhbGciOiJIUzI1NiJ9.U2lsIEI.cJlfh-J53quTXCbAFWXImGXV9XWJxASbWf5N2ktBo6Q');
...
-- Listage des données de la table school_management.trims : ~1 rows (environ)
/*!40000 ALTER TABLE `trims` DISABLE KEYS */;
INSERT IGNORE INTO `trims` (`id`, `name`, `seqIds`) VALUES
